...
class ApiBase extends Base
{
    ...
    protected $result_rule = ['code' => 200, 'data' => [], 'msg' => 'GO!'];
	 ...
	 * @param string $msg
	 */
	public function result_arr($code = 200, $data = [], $msg = 'GO!')
	{
	    $this->result_rule = ['code' => $code, 'data' => $data, 'msg' => $msg];
	    if (Z_API_DEBUG) {
	        return json_encode($this->result_rule, true);
	    }
	    die(json_encode($this->result_rule));
	}
